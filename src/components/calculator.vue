    ...
    <footer class="footer">
      <div class="content has-text-centered">
        <p>
          ...
          <p class="is-small">Disclaimer: The content and technology on this webpage are for information purposes only and are not intended as financial advice or any other type of advice. The results from this ROI calculator does not represent real world results.</p>
